...
;in paint, get brown color and invert color
;click_color_radial(0x4685A8, centerX, centerY)
loop, 3 {
click_color_radial(0xff4d00, centerX, centerY, 20)
Sleep, rand_range(1500,2500)
}
return
...
sleep_click(x, y) {
	...
	x += target_random(-30,0,30)
	y += target_random(-30,0,30)
	;MoveMouse(x, y)
	MouseMove, %x%, %y%, 50
